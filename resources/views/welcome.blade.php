...
<body class="bg-[var(--task-canvas)] text-[var(--task-text)] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6 not-has-[nav]:hidden">
        ...
        <nav class="flex items-center justify-end gap-4">
            ...
            <a
                href="{{ url('/dashboard') }}"
                class="inline-block px-5 py-1.5 border border-[var(--task-border)] text-[var(--task-text)] rounded-sm text-sm leading-normal hover:bg-[var(--task-surface)]">
                Dashboard
            </a>
            @else
            <a
                href="{{ route('login') }}"
                class="inline-block px-5 py-1.5 text-[var(--task-text)] border border-transparent hover:border-[var(--task-border)] rounded-sm text-sm leading-normal">
                Log in
            </a>
    ...
    <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div class="text-[13px] leading-[20px] flex-1 p-6 pb-6 lg:p-20 lg:pb-10 bg-[var(--task-surface)] text-[var(--task-text)] shadow-[inset_0px_0px_0px_1px_rgba(43,49,57,0.9)] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                <h1 class="mb-1 font-medium">Let's get started</h1>
                <p class="mb-2 text-[var(--task-muted)]">With so many options available to you,<br /> we suggest you start with the following:</p>
                <ul class="flex flex-col mb-4 lg:mb-6">
                    <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute">
                        ...
                        <span>
                            Read the
                            <a href="https://laravel.com/docs" target="_blank" class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[var(--task-accent)] ml-1">
                    ...
                    <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:bottom-1/2 before:top-0 before:left-[0.4rem] before:absolute">
                        ...
                        <span>
                            ...
                            <a href="https://laracasts.com" target="_blank" class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[var(--task-accent)] ml-1">
                                <span>Laracasts</span>
                                <svg
                                    width="10"
                                    height="11"
                ...
                <ul class="flex gap-3 text-sm leading-normal">
                    <li>
                        <a href="https://cloud.laravel.com" target="_blank" class="inline-block px-5 py-1.5 bg-[var(--task-accent)] rounded-sm border border-[var(--task-accent)] text-[var(--task-canvas)] text-sm leading-normal hover:bg-[var(--task-accent-active)] hover:border-[var(--task-accent-active)]">
                            Deploy now
                        </a>
                    </li>
                </ul>

                <p class="mt-6 lg:mt-10 text-[var(--task-muted)]">
                    v{{ app()->version() }}
                    <a href="https://github.com/laravel/framework/blob/13.x/CHANGELOG.md" target="_blank" class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[var(--task-accent)] ml-1">
